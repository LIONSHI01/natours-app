...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXJsaW9uOTEiLCJhIjoiY2w1NWVzaW1yMTQwYzNpbjU2ejVoNW8wMCJ9.FCdfywynoFEVQU3KwzXoZg';
...
var updateUserPasswordForm = document.querySelector('.form-user-settings'); // DELEGATION (Prevent error when in pages without Map)
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              document.getElementById('password-confirm').value = ''; // NOTE: since we use await for updateUserPassword(), so codes below will be run after Promise finish
